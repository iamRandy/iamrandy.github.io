...
function Art () {
                ...
                if (classes.includes("threebox")) {
                    ...
                    if (!classes.includes("selected")) {
                        ...
                        if (prev) {
                            ...
                            prev.style.transform = 'perspective(400px) rotateX(0deg) rotateY(0deg)';
                        }
    ...
    return(
        <div className="banner">
            ...
            <div id="overlay" className="selected overlay hidden">
            ...
            <div id="row1" className="row">
                <div id="box1" className="threebox"></div>
                <div id="box2" className="threebox"></div>
                <div id="box3" className="threebox"></div>
            </div>
            <div id="row2" className="row">
                <div id="box4" className="threebox"></div>
                <div id="box5" className="largebox threebox"></div>
            </div>
