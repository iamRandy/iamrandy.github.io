...
function App() {
  ...
  return (
    ...
    <div id="MAIN" className="min-h-80 flex flex-col">
      <div className="linkButton home">
        <a href="#MAIN" className="linkIcon">
          <svg xmlns="http://www.w3.org/2000/svg" width="80%" height="80%" fill="white" class="bi bi-house" viewBox="0 0 16 16">
